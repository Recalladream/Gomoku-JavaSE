...
import dao.DataBase;
import server_utils.Email;
import inf.InforMationSet;
import server_utils.MatchingTiming;
...
public class InfClassification {
    ...
    public InfClassification(InforMationSet getinfjh, Socket KH, ObjectOutputStream obputkh, ArrayList<String> yhztlist, HashMap<String,Socket>map, HashMap<Socket,ObjectOutputStream>putmap, HashMap<String,String>matchmap, InforMationSet bdjs, Connection con){
        this.KH=KH;
    ...
    public void functionalresolution(){
        ...
        if (function.equals("Get_mail")){
            try {
                ...
                String code= Email.getEmail().getCode();
                String state=Email.getEmail().sendEmail(mail,code,smg);
