...
import client_utils.AddRecord;
import inf.InforMationSet;
import client_utils.MD5;
...
public class LoginInter {
    ...
    public static void initImage(){
        ...
        zcimage = new ImageIcon("E:\\java\\java代码\\Gomoku\\client-side\\src\\main\\resource\\RegistrationBackground.png");
        zhbsimage=new ImageIcon("E:\\java\\java代码\\Gomoku\\client-side\\src\\main\\resource\\AccountIdentification.png");
        passbsimage=new ImageIcon("E:\\java\\java代码\\Gomoku\\client-side\\src\\main\\resource\\PasswordIdentification.png");
        ycimage=new ImageIcon("E:\\java\\java代码\\Gomoku\\client-side\\src\\main\\resource\\Hide.png");
